    ...
    loader.innerHTML = `
      <div class="slide-bg" style="display:flex; justify-content:center; align-items:center; background-color: #000;">
        <div class="logo-wrapper" style="position:relative; height: 60vh; display: flex; justify-content: center;">
          ...
          <div class="flame-anchor" style="position: absolute; left: 48.5%; top: 63%; width: 0; height: 0; z-index: 3; transform: scale(1.8);">
            <div class="flame-container">
                <div class="flame-glow"></div>
                <div class="flame-core"></div>
                <div class="flame-particle" style="width: 15px; height: 25px; animation-delay: 0s"></div>
                <div class="flame-particle" style="width: 12px; height: 22px; animation-delay: 0.2s"></div>
                <div class="flame-particle" style="width: 14px; height: 24px; animation-delay: 0.4s"></div>
                <div class="flame-particle" style="width: 10px; height: 20px; animation-delay: 0.6s"></div>
                <div class="flame-particle" style="width: 13px; height: 23px; animation-delay: 0.8s"></div>
            </div>
            <!-- Reflection -->
            <div class="flame-container reflection">
                <div class="flame-glow"></div>
                <div class="flame-core"></div>
                <div class="flame-particle" style="width: 15px; height: 25px; animation-delay: 0s"></div>
                <div class="flame-particle" style="width: 12px; height: 22px; animation-delay: 0.2s"></div>
        ...
        slideEl.innerHTML = `
          <div class="slide-bg" style="display:flex; justify-content:center; align-items:center; background-color: #000;">
            <div class="logo-wrapper" style="position:relative; height: 60vh; display: flex; justify-content: center;">
              ...
              <div class="flame-anchor" style="position: absolute; left: ${slide.flameLeft || '48.5%'}; top: ${slide.flamePosition || '63%'}; width: 0; height: 0; z-index: 3; transform: scale(1.8);">
                <div class="flame-container">
                    <div class="flame-glow"></div>
                    <div class="flame-core"></div>
                    <div class="flame-particle" style="width: 15px; height: 25px; animation-delay: 0s"></div>
